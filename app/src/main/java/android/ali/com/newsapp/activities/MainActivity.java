package android.ali.com.newsapp.activities;

import android.ali.com.newsapp.NewsApp;
import android.ali.com.newsapp.R;
import android.ali.com.newsapp.consts.Urls;
import android.ali.com.newsapp.data.OverviewObj;
import android.ali.com.newsapp.fragments.NewsFragment;
import android.ali.com.newsapp.utils.Utils;
...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeNewsAPIRequest(Urls.CNN_NEWS);
    }
        ...
        try {
            ...
            for (int i = 0; i < articles.length(); i++){
                ...
                if(getSupportFragmentManager().findFragmentById(R.id.flContent) instanceof NewsFragment) {
                    ...
                    OverviewObj obj = new OverviewObj(source, title, description, imageUrl, articleUrl);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(!Utils.isNetworkAvailable()) {
                    errMsg += " " + NewsApp.getInstance().getResources().getString(R.string.no_internet);
                }
